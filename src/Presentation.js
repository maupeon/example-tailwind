              ...
              <div className="relative px-4 pt-6 sm:px-6 lg:px-8">
                ...
                >
                  ...
                  <div className="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
                    ...
                    <a href="/" className="font-medium text-red-600 hover:text-indigo-500">
                      Contactar
                    </a>
                  </div>
                </nav>
              ...
              <main className="px-4 mx-auto mt-10 max-w-7xl sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                <div className="sm:text-center lg:text-left from-green-400 to-blue-500" >
                  <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
                    <span className="block xl:inline dark:text-white">MEDU Publicidad</span>{' '}
                    <span className="block text-transparent bg-clip-text bg-gradient-to-l from-meduBlue to-meduGreen xl:inline ">trabajemos juntos</span>
                  </h1>
