    ...
    <div className="py-16 font-sans bg-white dark:bg-black lg:py-40">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="lg:text-center">
          <h2 className="text-base font-semibold tracking-wide uppercase text-meduBlue">Patrocinios</h2>
            ...
            {features.map((feature) => (
              <div key={feature.name}>
                <dt>
                  ...
                  <p className="mb-0 ml-16 text-lg font-medium leading-6 text-gray-900 dark:text-gray-200">{feature.name}</p>
                </dt>
